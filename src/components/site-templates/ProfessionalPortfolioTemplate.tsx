MessageSquare, Tools -> Tool) and defining accentColorBorderClass.">
"use client";
...
export function ProfessionalPortfolioTemplate({ siteData }: ProfessionalPortfolioTemplateProps) {
  ...
  const skills = [
    {
      ...
      items: [
        ...
        { name: "Aménagement intérieur", level: "Expert" },
        { name: "Rénovation énergétique", level: "Avancé" },
        { name: "Ravalement de façade", level: "Intermédiaire" },
      ],
    },
    {
      ...
      category: "Réparation",
      items: [
        { name: "Plomberie", level: "Expert" },
        { name: "Électricité", level: "Expert" },
        { name: "Menuiserie", level: "Avancé" },
        { name: "Serruerie", level: "Intermédiaire" },
      ],
    },
    {
      ...
      category: "Finitions",
      items: [
        { name: "Peinture décorative", level: "Expert" },
        { name: "Pose de carrelage", level: "Expert" },
        { name: "Pose de parquet", level: "Avancé" },
        { name: "Staff & moulures", level: "Intermédiaire" },
      ],
    },
  ];
  ...
  return (
    <div className="font-sans antialiased text-gray-800 bg-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section id="accueil" className={cn("relative py-32 text-white text-center bg-cover bg-center", primaryColorClass)} style={{ backgroundImage: `linear-gradient(135deg, rgba(44, 62, 80, 0.9) 0%, rgba(52, 152, 219, 0.8) 100%), url('https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1500&q=80')` }}>
